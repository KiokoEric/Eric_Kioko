    ...
    <div className='Projects' >
        ...
        <Link className='Link EBudgets' to="/EBudget" >
            <figure>
                ...
                <figcaption>
                    <h2>EBudget</h2>
                    <p>EBudget is a user-friendly and efficient financial application designed to help individuals manage their finances with ease and precision. The application offers a streamlined interface and a range of features that simplify revenue and expense tracking and loan calculation.</p>
                    <div>
                        <i class="fa-brands fa-react"></i>
                        <SiExpress size="2.1rem" className='React' />
                        <SiMongodb size="2.1rem" className='React' />
